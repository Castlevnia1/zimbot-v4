...
global.botnma = 'CHITOGE BOT' //bot name
global.botname = 'CHITOGE BOT'
global.ownername = '💫ᴄᴀꜱᴛʟᴇᴠɴɪᴀ 先輩🍁' //owner name
global.packname = '💫ᴄᴀꜱᴛʟᴇᴠɴɪᴀ 先輩🍁' //sticker package name
global.author = 'By 💫ᴄᴀꜱᴛʟᴇᴠɴɪᴀ 先輩🍁' //sticker author name
...
global.mess = {
    ...
    botAdmin: '*Chitoge  must be admin first!*',
    owner: '*this feature is only for Owner*',
    group: '*Feature is only for groups!*',
    grouponly: '*Group Mode Only*',
    private: 'Features Used Only For Private Chat!',
    bot: 'This feature in only for the bot number',
    wait: '*whoa wait a moment Chitoge is proccessing*',
